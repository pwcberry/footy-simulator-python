...
class TestForwardsZoneMatrix(unittest.TestCase):
    def setUp(self):
        self.states = [
            ...
            s.HOME_TEAM_BEHIND_STATUS, s.HOME_TEAM_GOAL_STATUS,
    ...
    def test_zone_returns_expected_field_zone(self):
        matrix = m.ForwardsZoneMatrix(self.home_team, self.away_team, s.AttackDistance.FIFTY_METRES)
        self.assertEqual(matrix.zone, s.FieldZone.FORWARDS)
